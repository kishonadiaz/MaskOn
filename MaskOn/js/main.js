...
function processResults(detections) {
    ...
    try {
        ...
        modeld.position.lerp(new THREE.Vector3((((midX - .45) + (midX - .45)) * 10) - 0.007945, -(((midY - .35) + (midY - .35)) * 10) + 0.007945, ((faceTransform.position.z + 2) + (faceTransform.scale - 2)) * 10), 0.3);
        facecamera.position.lerp(new THREE.Vector3(-(((midX - .55) + (midX - .55)) * 10) - 0.007945, (((midY - .5) + (midY - .5)) * 10) - 0.007945, 19.2 - faceTransform.scale ^ 2), 0.3);
